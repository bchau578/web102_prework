...
const unfundedString = unfundedCount === 0 ? "All games are fully funded!" :
    `However, ${unfundedCount} game${unfundedCount > 1 ? 's' : ''} still need additional funding.`;

// create a new DOM element containing the template string and append it to the description container
const companyInfo = `
    <p>Welcome to Our Games Inc. We are currently funding ${gamesCard.innerHTML} games.</p>
    <p>${unfundedString}</p>
`;
const companyInfoElement = document.createElement('div');
companyInfoElement.innerHTML = companyInfo;
